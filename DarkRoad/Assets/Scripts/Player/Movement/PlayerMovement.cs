...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        GetComponent<ControlsReader>().JumpEvent += OnJumpInput;
        GetComponent<ControlsReader>().ReleasedJumpEvent += OnJumpUpInput;
        GetComponent<ControlsReader>().DashEvent += OnDashInput;
    }
    ...
    private void Update()
    {
        ...
        _moveInput.x = GetComponent<ControlsReader>().MovementValue.x; // Input.GetAxisRaw("Horizontal");
        _moveInput.y = GetComponent<ControlsReader>().MovementValue.y; // Input.GetAxisRaw("Vertical");
